...
def mainloop(argsQueue):
    ...
    if window:
        ...
        while True:
            ...
            # 截取多个区域的截图
            # 钓鱼按钮范围截图
            screenshot1 = capture_window_area(window, 2000, 1150, 2250, 1350)
            # 右侧按钮位置
            screenshot2 = capture_window_area(window, 1580, 500, 1755, 560)
            # 左侧按钮位置
            screenshot3 = capture_window_area(window, 1530, 500, 1700, 560)
            # 显示截图
            display_screenshots(screenshot1, screenshot2, screenshot3)
            # 模板匹配
