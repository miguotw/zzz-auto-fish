...
def mainloop():
    ...
    if window:
        ...
        # 设置钓鱼按钮图标的区域范围
        left, top, right, bottom = 2030, 1153, 2236, 1358
        ...
        while True:
            ...
            # 右侧按钮位置
            screenshot2 = capture_window_area(window, 1625, 501, 1715, 555)
            # 左侧按钮位置
            screenshot3 = capture_window_area(window, 1529, 505, 1615, 558)
